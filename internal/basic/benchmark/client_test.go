...
// It is recommended to test websocket using the following URL: http://coolaf.com/tool/chattest

// First run the startup method under CMD to start the logic server of IM
// Step 2: open the websocket test website to test the connection: ws://127.0.0.1:8080/conn?token=12345
